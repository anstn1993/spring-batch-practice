...
insert into member (id, username, age)values (1,'user1',30);
insert into member (id, username, age)values (2,'user2',31);
insert into member (id, username, age)values (3,'user3',32);
insert into member (id, username, age)values (4,'user4',33);
insert into member (id, username, age)values (5,'user5',34);
insert into member (id, username, age)values (6,'user6',35);
insert into member (id, username, age)values (7,'user7',36);
insert into member (id, username, age)values (8,'user8',37);
insert into member (id, username, age)values (9,'user9',38);
insert into member (id, username, age)values (10,'user10',39);
